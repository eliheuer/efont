...
const METRICS_COLOR: Color = Color::rgb8(0x00, 0xff, 0x99);
...
const SMOOTH_POINT_COLOR: Color = Color::rgb8(0x33, 0xaa, 0xff);
const CORNER_POINT_COLOR: Color = Color::rgb8(0x00, 0xff, 0x99);
const OFF_CURVE_POINT_COLOR: Color = Color::rgb8(0xff, 0x33, 0xff);
const OFF_CURVE_HANDLE_COLOR: Color = Color::rgb8(0x33, 0xaa, 0xff);
...
const SMOOTH_SELECTED_RADIUS: f64 = 10.;
const OFF_CURVE_RADIUS: f64 = 6.;
const OFF_CURVE_SELECTED_RADIUS: f64 = 8.;
...
impl<'a, 'b: 'a> DrawCtx<'a, 'b> {
    ...
    fn draw_open_path_terminal(&mut self, seg: &kurbo::PathSeg, selected: bool) {
        ...
        if selected {
            self.stroke(cap, &OFF_CURVE_HANDLE_COLOR, 4.0);
        } else {
